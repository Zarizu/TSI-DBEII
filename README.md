...
- TEAMS
- POST /teams
- body: { "name": "Time Alpha","gold": 1000 }
- GET /teams
- GET /teams/:id
- GET /teams/:id/members
- PATCH /teams/:id/gold
- body: { "add_amount": 2000 }
- DELETE /teams/:id
- MISSIONS
- POST /missions
- body: { "name": "Limpeza de Globens","description": "Proteger as muralhas contra
- os Globens",“reward”: 1000 }
- GET /missions
- GET /missions/:id
- PUT /missions/:id
- body:{ "name": "Escola ao chungas","description": "Missão defensiva para proteção
- do chungas",“reward”: 500}
...
- body: { "name": "Espada Longa","amount": 1}
- GET /members/:member_id/items
- PUT /items/:id
- body: { "name": "Espada Lendária","amount": 2 }
...
### TO-DO ######################################################################
- Adaptar os Models de acordo com os Tutorials.
- Mudar o ReadMe de acordo com a proposta